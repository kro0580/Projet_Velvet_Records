...
// Requête SQL pour mettre à jour les valeurs ajoutées dans le formulaire
...
else
{
    ...
    header("Location:update_form.php?disc_id=".$disc_id."&".$sUrl); // On affiche les erreurs dans le formulaire formulaire.php
