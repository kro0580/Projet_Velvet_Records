   ...
   resultat=true;
       ...
       if($('#artist_id').val() === null){
        ...
        if(document.getElementById("fichier").value === ""){
            ...
            $('#alert_picture').text('Ce champ est requis').css("color", "#FF0000");
 
        resultat = false;
        }
        else if(document.getElementById("fichier").size > 5 * 1024 * 1024){
            $('#fichier').addClass('is-invalid');
            $('#alert_picture').text('Ce fichier est trop volumineux').css("color", "#FF0000");
        
        resultat = false;
        }
        else if(regFichier.test($('#fichier').val()) === false){
            $('#fichier').addClass('is-invalid');
